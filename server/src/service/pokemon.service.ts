...
export class PokemonService {
  ...
  map(pokemon: PokemonDatabase): Pokemon {
    return {
      ...
      color: pokemon.color,
      colorId: pokemon.color_id,
      shape: pokemon.shape,
      shapeDescription: pokemon.shape_description,
      type1: pokemon.type1,
      type1Id: pokemon.type1_id,
      type2: pokemon.type2,
      type2Id: pokemon.type2_id,
      eggGroup1: pokemon.egg_group1,
      eggGroup1Id: pokemon.egg_group1_id,
      eggGroup2: pokemon.egg_group2,
      eggGroup2Id: pokemon.egg_group2_id,
      hp: pokemon.hp,
